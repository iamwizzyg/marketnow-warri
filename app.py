...
<div class="section">
    ...
    <div class="cards">
        ...
        <div class="card">
            ...
            <p>Traders with fresh stock have no way to tell buyers what is available before they make the trip. Sales die silently.</p>
        </div>
        <div class="card">
            <div class="card-icon">💬</div>
...
<div class="demo-section" style="padding: 40px 20px;">
    ...
    <div class="qr-section">
        <div class="qr-box">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=https://wa.me/14155238886?text=join%20atomic-statement" alt="QR Code to join WhatsApp bot" />
        </div>
        <div class="qr-label">Scan to open WhatsApp</div>
        <div class="join-code">First message: join atomic-statement</div>
        <div class="qr-label">Then send any trader or buyer message</div>
    </div>
</div>
...
<div class="footer">
    ...
    <p style="margin-top: 6px;">Stack: Python · Flask · Twilio · Google Sheets · Render</p>
</div>
